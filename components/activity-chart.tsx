...
export const ActivityChart = () => {
    return (
        <section className='py-7 px-6 flex flex-col gap-4 bg-white rounded-xl'>
            <span className='flex items-center gap-2 self-start'>
                <FaDatabase />
                <p className='text-dark-grey font-medium tracking-[-0.48px] leading-6 text-base'>Activity Charts</p>
            </span>
